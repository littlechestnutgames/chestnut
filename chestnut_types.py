...
class ChestnutUInt256(ChestnutUnsignedInteger):
    BIT_WIDTH = 256
    MASK = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
    MAX = 2**256-1

class ChestnutUInt512(ChestnutUnsignedInteger):
    BIT_WIDTH = 512
    MASK = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
    MAX = 2**512-1

class ChestnutUInt1024(ChestnutUnsignedInteger):
    BIT_WIDTH = 1024
    MASK = 
    MAX = 2**1024-1
